...
public class RFX4_RaycastCollision : MonoBehaviour
{
    ...
    public Action<Vector3, Vector3> onCollision;
    ...
    private void UpdateRaycast()
    {
        ...
        //if(Physics.SphereCast(ray, 1f, out raycastHit, RaycastDistance))
        if (Physics.Raycast(transform.position, transform.forward, out raycastHit, RaycastDistance))
        {
            ...
            if (onCollision != null)
                onCollision(position, raycastHit.point + raycastHit.normal);
        }
